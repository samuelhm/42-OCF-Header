...
function! s:insert_cpp()
	...
	call append(16, l:classname . "::" . l:classname . "(const " . l:classname . " &other) { *this = other; }")
	call append(17, l:classname . "& " . l:classname . "::operator=(const " . l:classname . " &other)")
	call append(18, "{")
	call append(19, "	if (this != &other)")
	call append(20, "	{")
	call append(21, "		// Copiar los atributos necesarios")
	call append(22, "	}")
	call append(23, "	return *this;")
	call append(24, "}")
	call append(25, l:classname . "::~" . l:classname . "() {}")
	call append(26, "")
endfunction
